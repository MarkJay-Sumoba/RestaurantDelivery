        ...
        <div class="row d-flex justify-content-center align-items-center">
          <div class="col-lg-4">
            <div class="info-container flex-column">
              ...
              <div class="location-item py-1">
                <h3>Follow Us</h3>
                <div class="icon"><a href=""><i class="bi bi-instagram text-dark"></i></a><a href=""><i
                      class="bi bi-facebook text-dark mx-2"></i></a><a href=""><i class="bi bi-twitter-x text-dark"></i></a></div>
              </div>
            </div>
          </div>
